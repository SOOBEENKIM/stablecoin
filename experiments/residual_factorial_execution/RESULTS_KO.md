...
| 비교 | 손실 개선율 | 개별95% 구간 | Holm p | 주 기준 |
| --- | --- | --- | --- | --- |
| R: ML 선택 vs 선형 | +4.127% | [-0.003, +8.444]% | 0.4290 | 미충족 |
| F: ML 선택 vs 선형 | +3.853% | [+0.032, +7.588]% | 0.4290 | 미충족 |
| 시장 정보 추가: B vs R | -0.452% | [-2.152, +1.279]% | 1.0000 | 미충족 |
| 포지셔닝 추가: F vs B | +0.245% | [-1.048, +1.559]% | 1.0000 | 미충족 |
| 전체 정보 추가: F vs R | -0.205% | [-1.487, +1.087]% | 1.0000 | 미충족 |
| F: ML 선택 vs 문턱형 | +2.677% | [-1.107, +8.418]% | 1.0000 | 미충족 |
...
| 입력 | 선형 | QRF | 부스팅 | 문턱형 | ML 선택 |
| --- | --- | --- | --- | --- | --- |
| R | 1.755907 | 1.687110 | 1.704643 | 1.691230 | 1.683446 |
| B | 1.725531 | 1.682545 | 1.706929 | 1.716286 | 1.691052 |
| F | 1.754507 | 1.673386 | 1.694439 | 1.733303 | 1.686902 |
...
| 전체 입력의 절차 | 이전 손실(bp) | 이번 손실(bp) | 이전 대비 손실 감소 |
| --- | --- | --- | --- |
| 선형 | 1.892994 | 1.754507 | 7.316% |
| 선택 절차 | 1.691431 | 1.686902 | 0.268% |
...
| 동일 후보의 원예측 비교 | 개선율 | 개별95% 구간 |
| --- | --- | --- |
| R: ML 선택 vs 선형 | +1.388% | [-7.231, +10.899]% |
| F: ML 선택 vs 선형 | +1.372% | [-8.241, +11.015]% |
| 시장 정보 추가: B vs R | +0.918% | [-0.530, +2.403]% |
| 포지셔닝 추가: F vs B | -0.243% | [-1.210, +0.655]% |
| 전체 정보 추가: F vs R | +0.677% | [-0.823, +2.120]% |
| F: ML 선택 vs 문턱형 | +2.723% | [-1.365, +7.912]% |
...
| 고정 보조 비교 | 개선율 | 개별95% 구간 | 다중비교 보정 전 p |
| --- | --- | --- | --- |
| qrf_vs_linear_F | +4.624% | [+0.783, +8.349]% | 0.0290 |
| boosting_vs_linear_F | +3.424% | [+0.322, +6.739]% | 0.0565 |
| matched_market | -0.414% | [-1.578, +0.792]% | 0.4960 |
| matched_position | +0.208% | [-0.480, +0.930]% | 0.5625 |
| matched_total | -0.205% | [-1.487, +1.087]% | 0.7585 |
...
| 조건 | 비교 | 개선율 | 개별95% 구간 |
| --- | --- | --- | --- |
| available_macro/CAP | F: ML 선택 vs 선형 | +7.072% | [+1.854, +12.107]% |
| available_macro/CAP | 포지셔닝 추가: F vs B | -0.076% | [-2.172, +2.035]% |
| available_macro/CAP | F: ML 선택 vs 문턱형 | +7.269% | [+3.776, +10.393]% |
| available_macro/EQ | F: ML 선택 vs 선형 | +3.853% | [+0.032, +7.588]% |
| available_macro/EQ | 포지셔닝 추가: F vs B | +0.245% | [-1.048, +1.559]% |
| available_macro/EQ | F: ML 선택 vs 문턱형 | +2.677% | [-1.107, +8.418]% |
| available_macro/PCA | F: ML 선택 vs 선형 | +4.865% | [+1.123, +8.646]% |
| available_macro/PCA | 포지셔닝 추가: F vs B | +1.007% | [+0.145, +1.895]% |
| available_macro/PCA | F: ML 선택 vs 문턱형 | +2.990% | [+0.168, +6.303]% |
| strict/EQ | F: ML 선택 vs 선형 | +11.101% | [+7.471, +14.214]% |
| strict/EQ | 포지셔닝 추가: F vs B | -0.144% | [-2.309, +2.230]% |
| strict/EQ | F: ML 선택 vs 문턱형 | -4.959% | [-11.924, +1.289]% |
...
- 독립 계산으로 후보 보정과 선택을 대조했다. 보정 최대 차이0.0bp,1월84개 고유 모형 재적합 최대 차이0.0bp였다. 제외 입력을 교란한56개 추가 재적합도 일치했다.
- 독립적인 일별 합산과 관측행 가중 재표집의 최대 차이는1.55e-15bp였다. 기존과 평가 시점/정답도 일치했다.
