...
Completed and independently verified. [Korean results](/home/ssd-990/soobeenkim/stablecoin_workshop/option1_model_followup_20260910/RESULTS_KO.md). GRU improves over the earlier TCN. Hard-tick TCN reduces observed-input loss by 1.63%, one-hour worst-scenario loss by 4.46%, and sensitivity by 78.08% versus the earlier tick-augmentation TCN. Worst-loss differences survive Holm12/16 correction, but the locked 10% worst-loss reduction target is not met. All 96 new checkpoints were replayed. This is a positive exploratory result, not an independent confirmatory study or a full joint-gate success. Option 3 remains paused.
