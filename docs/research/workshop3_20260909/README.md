> GitHub 탐색용 사본입니다. [체크섬이 보존된 원본](../../../research/workshop3_20260909/README.md)의 내용과 과거 시점 표기를 유지하고 문서 링크만 변환했습니다. 실행은 [현재 재현 안내](../../REPRODUCING.md)를 따릅니다.

# stablecoin_workshop 3안

**현재 상태: 3안 재설계·자료 준비·시간 정렬 검증 완료. 새 AI 적합은 아직 실행하지 않음.**

- [연구 방향과 차별성 판단](RESEARCH_DESIGN_KO.md)
- [고정된 후속 실험 사양](EXPERIMENT_PROTOCOL_KO.md)
- [실제 관측 수](../../../research/workshop3_20260909/feasibility_counts.csv)
- [자료 검증 기록](../../../research/workshop3_20260909/FEASIBILITY_MANIFEST.json)
