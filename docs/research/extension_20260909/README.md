> GitHub 탐색용 사본입니다. [체크섬이 보존된 원본](../../../research/extension_20260909/README.md)의 내용과 과거 시점 표기를 유지하고 문서 링크만 변환했습니다. 실행은 [현재 재현 안내](../../REPRODUCING.md)를 따릅니다.

# Stablecoin workshop extension

Read [RESEARCH_FINDINGS_KO.md](RESEARCH_FINDINGS_KO.md) for the current findings and limits. [WORKSHOP_DRAFT.md](WORKSHOP_DRAFT.md) is the editable English paper; [WORKSHOP_DRAFT.pdf](../../../research/extension_20260909/WORKSHOP_DRAFT.pdf) is its review rendering. The PDF is a review draft, not a claim of compliance with a final conference template or completed author review.
