> GitHub 탐색용 사본입니다. [체크섬이 보존된 원본](../../../research/extension_20260909/WORKSHOP_DRAFT.md)의 내용과 과거 시점 표기를 유지하고 문서 링크만 변환했습니다. 실행은 [현재 재현 안내](../../REPRODUCING.md)를 따릅니다.
...
![Figure 1. Local-state and offshore information contributions. Positive values indicate lower candidate loss. Intervals are conditional five-day block intervals, unadjusted across the displayed secondary cells.](../../../research/extension_20260909/information_contribution.png)
...
![Figure 2. Post-reform one-tick arithmetic sensitivity and observed reference-basis dispersion. Monthly medians are used on the left; the right compares two different reference definitions, not counterfactual market outcomes.](../../../research/extension_20260909/tick_sensitivity.png)
