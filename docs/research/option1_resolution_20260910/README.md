> GitHub 탐색용 사본입니다. [체크섬이 보존된 원본](../../../research/option1_resolution_20260910/README.md)의 내용과 과거 시점 표기를 유지하고 문서 링크만 변환했습니다. 실행은 [현재 재현 안내](../../REPRODUCING.md)를 따릅니다.

# Relative price-grid sensitivity: completed option-1 extension

Read [Korean findings and conclusion](RESULTS_KO.md).
