> GitHub 탐색용 사본입니다. [체크섬이 보존된 원본](../../../research/workshop2_20260909/README.md)의 내용과 과거 시점 표기를 유지하고 문서 링크만 변환했습니다. 실행은 [현재 재현 안내](../../REPRODUCING.md)를 따릅니다.

# 워크숍 2안

[연구 방향·최신 문헌·실험 보고서](WORKSHOP2_DESIGN_AND_EVIDENCE_KO.md)를 먼저 읽는다.
